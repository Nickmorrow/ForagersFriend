...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251216021548_FixUserImagesRelationship")]
    partial class FixUserImagesRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Models.UserMessage", b =>
                {
                    ...
                    b.Property<Guid?>("UsmParentMessageId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Models.UserThreadState", b =>
                {
                    ...
                    b.Property<DateTime?>("UtsLastInboundUtc")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("UtsLastOutboundUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DataAccess.Models.UserMessage", b =>
                {
                    ...
                    b.HasOne("DataAccess.Models.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("UsmRecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataAccess.Models.User", "Sender")
                        .WithMany()
                        .HasForeignKey("UsmSenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
