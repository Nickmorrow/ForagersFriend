...
namespace DataAccess.Models
{
    ...
    public class UserMessage
    {
        ...
        [JsonIgnore] public UserMessageThread Thread { get; set; } = default!;
        ...
        [JsonIgnore] public User Sender { get; set; } = default!;

        [Required]
        public Guid UsmRecipientId { get; set; }
        [JsonIgnore] public User Recipient { get; set; } = default!;
